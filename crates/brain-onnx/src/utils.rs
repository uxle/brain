...
/// Struct UTILS_S1 for brain-onnx data handling.
...
/// Struct UTILS_S2 for brain-onnx data handling.
...
/// Struct UTILS_S3 for brain-onnx data handling.
...
/// Struct UTILS_S4 for brain-onnx data handling.
...
/// Struct UTILS_S5 for brain-onnx data handling.
...
/// Struct UTILS_S6 for brain-onnx data handling.
...
/// Struct UTILS_S7 for brain-onnx data handling.
...
/// Struct UTILS_S8 for brain-onnx data handling.
...
/// Struct UTILS_S9 for brain-onnx data handling.
...
/// Struct UTILS_S10 for brain-onnx data handling.
...
/// Struct UTILS_S11 for brain-onnx data handling.
...
/// Struct UTILS_S12 for brain-onnx data handling.
...
/// Struct UTILS_S13 for brain-onnx data handling.
...
/// Struct UTILS_S14 for brain-onnx data handling.
...
/// Trait UTILS_T0 defining interface for brain-onnx.
pub trait UTILS_T0 {
...
/// Trait UTILS_T1 defining interface for brain-onnx.
pub trait UTILS_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T2 defining interface for brain-onnx.
pub trait UTILS_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T3 defining interface for brain-onnx.
pub trait UTILS_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T4 defining interface for brain-onnx.
pub trait UTILS_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T5 defining interface for brain-onnx.
pub trait UTILS_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// comprehensive brain-onnx library. Each function is carefully optimized
