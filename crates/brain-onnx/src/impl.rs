...
/// Struct IMPL_S0 for brain-onnx data handling.
...
/// Struct IMPL_S1 for brain-onnx data handling.
...
/// Struct IMPL_S2 for brain-onnx data handling.
...
/// Struct IMPL_S3 for brain-onnx data handling.
...
/// Struct IMPL_S4 for brain-onnx data handling.
...
/// Struct IMPL_S5 for brain-onnx data handling.
...
/// Struct IMPL_S6 for brain-onnx data handling.
...
/// Struct IMPL_S7 for brain-onnx data handling.
...
/// Struct IMPL_S8 for brain-onnx data handling.
...
/// Struct IMPL_S9 for brain-onnx data handling.
...
/// Struct IMPL_S10 for brain-onnx data handling.
...
/// Struct IMPL_S11 for brain-onnx data handling.
...
/// Struct IMPL_S12 for brain-onnx data handling.
...
/// Struct IMPL_S13 for brain-onnx data handling.
...
/// Struct IMPL_S14 for brain-onnx data handling.
...
/// Trait IMPL_T0 defining interface for brain-onnx.
pub trait IMPL_T0 {
...
/// Trait IMPL_T1 defining interface for brain-onnx.
pub trait IMPL_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait IMPL_T2 defining interface for brain-onnx.
pub trait IMPL_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait IMPL_T3 defining interface for brain-onnx.
pub trait IMPL_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait IMPL_T4 defining interface for brain-onnx.
pub trait IMPL_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait IMPL_T5 defining interface for brain-onnx.
pub trait IMPL_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
