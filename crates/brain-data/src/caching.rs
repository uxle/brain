...
mod tests {
    ...
    #[test]
    fn test_caching_stress_413() {
        let mut c = SampleCache::new(5);
        let s = Sample::new(413, Tensor::zeros(vec![1]));
        c.put(s);
