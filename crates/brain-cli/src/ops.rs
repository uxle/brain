...
/// Struct OPS_S0 for brain-cli data handling.
...
/// Struct OPS_S1 for brain-cli data handling.
...
/// Struct OPS_S2 for brain-cli data handling.
...
/// Struct OPS_S3 for brain-cli data handling.
...
/// Struct OPS_S4 for brain-cli data handling.
...
/// Struct OPS_S5 for brain-cli data handling.
...
/// Struct OPS_S6 for brain-cli data handling.
...
/// Struct OPS_S7 for brain-cli data handling.
...
/// Struct OPS_S8 for brain-cli data handling.
...
/// Struct OPS_S9 for brain-cli data handling.
...
/// Struct OPS_S10 for brain-cli data handling.
...
/// Struct OPS_S11 for brain-cli data handling.
...
/// Struct OPS_S12 for brain-cli data handling.
...
/// Struct OPS_S13 for brain-cli data handling.
...
/// Struct OPS_S14 for brain-cli data handling.
...
/// Trait OPS_T0 defining interface for brain-cli.
pub trait OPS_T0 {
...
/// Trait OPS_T1 defining interface for brain-cli.
pub trait OPS_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait OPS_T2 defining interface for brain-cli.
pub trait OPS_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait OPS_T3 defining interface for brain-cli.
pub trait OPS_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait OPS_T4 defining interface for brain-cli.
pub trait OPS_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait OPS_T5 defining interface for brain-cli.
pub trait OPS_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
