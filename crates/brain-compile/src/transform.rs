...
/// Struct TRANS_S1 for brain-compile data handling.
...
/// Struct TRANS_S2 for brain-compile data handling.
...
/// Struct TRANS_S3 for brain-compile data handling.
...
/// Struct TRANS_S4 for brain-compile data handling.
...
/// Struct TRANS_S5 for brain-compile data handling.
...
/// Struct TRANS_S6 for brain-compile data handling.
...
/// Struct TRANS_S7 for brain-compile data handling.
...
/// Struct TRANS_S8 for brain-compile data handling.
...
/// Struct TRANS_S9 for brain-compile data handling.
...
/// Struct TRANS_S10 for brain-compile data handling.
...
/// Struct TRANS_S11 for brain-compile data handling.
...
/// Struct TRANS_S12 for brain-compile data handling.
...
/// Struct TRANS_S13 for brain-compile data handling.
...
/// Struct TRANS_S14 for brain-compile data handling.
...
/// Trait TRANS_T0 defining interface for brain-compile.
pub trait TRANS_T0 {
...
/// Trait TRANS_T1 defining interface for brain-compile.
pub trait TRANS_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait TRANS_T2 defining interface for brain-compile.
pub trait TRANS_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait TRANS_T3 defining interface for brain-compile.
pub trait TRANS_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait TRANS_T4 defining interface for brain-compile.
pub trait TRANS_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait TRANS_T5 defining interface for brain-compile.
pub trait TRANS_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// comprehensive brain-compile library. Each function is carefully optimized
