...
/// Struct UTILS_S0 for brain-vit data handling.
...
/// Struct UTILS_S1 for brain-vit data handling.
...
/// Struct UTILS_S2 for brain-vit data handling.
...
/// Struct UTILS_S3 for brain-vit data handling.
...
/// Struct UTILS_S4 for brain-vit data handling.
...
/// Struct UTILS_S5 for brain-vit data handling.
...
/// Struct UTILS_S6 for brain-vit data handling.
...
/// Struct UTILS_S7 for brain-vit data handling.
...
/// Struct UTILS_S8 for brain-vit data handling.
...
/// Struct UTILS_S9 for brain-vit data handling.
...
/// Struct UTILS_S10 for brain-vit data handling.
...
/// Struct UTILS_S11 for brain-vit data handling.
...
/// Struct UTILS_S12 for brain-vit data handling.
...
/// Struct UTILS_S13 for brain-vit data handling.
...
/// Struct UTILS_S14 for brain-vit data handling.
...
/// Trait UTILS_T0 defining interface for brain-vit.
pub trait UTILS_T0 {
...
/// Trait UTILS_T1 defining interface for brain-vit.
pub trait UTILS_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T2 defining interface for brain-vit.
pub trait UTILS_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T3 defining interface for brain-vit.
pub trait UTILS_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T4 defining interface for brain-vit.
pub trait UTILS_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait UTILS_T5 defining interface for brain-vit.
pub trait UTILS_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
