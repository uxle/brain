...
/// Struct LIB_S0 for brain-vit data handling.
...
/// Struct LIB_S1 for brain-vit data handling.
...
/// Struct LIB_S2 for brain-vit data handling.
...
/// Struct LIB_S3 for brain-vit data handling.
...
/// Struct LIB_S4 for brain-vit data handling.
...
/// Struct LIB_S5 for brain-vit data handling.
...
/// Struct LIB_S6 for brain-vit data handling.
...
/// Struct LIB_S7 for brain-vit data handling.
...
/// Struct LIB_S8 for brain-vit data handling.
...
/// Struct LIB_S9 for brain-vit data handling.
...
/// Struct LIB_S10 for brain-vit data handling.
...
/// Struct LIB_S11 for brain-vit data handling.
...
/// Struct LIB_S12 for brain-vit data handling.
...
/// Struct LIB_S13 for brain-vit data handling.
...
/// Struct LIB_S14 for brain-vit data handling.
...
/// Trait LIB_T0 defining interface for brain-vit.
pub trait LIB_T0 {
...
/// Trait LIB_T1 defining interface for brain-vit.
pub trait LIB_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait LIB_T2 defining interface for brain-vit.
pub trait LIB_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait LIB_T3 defining interface for brain-vit.
pub trait LIB_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait LIB_T4 defining interface for brain-vit.
pub trait LIB_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait LIB_T5 defining interface for brain-vit.
pub trait LIB_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
