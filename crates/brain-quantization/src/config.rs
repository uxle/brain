...
/// Struct CONFI_S0 for brain-quantization data handling.
...
/// Struct CONFI_S1 for brain-quantization data handling.
...
/// Struct CONFI_S2 for brain-quantization data handling.
...
/// Struct CONFI_S3 for brain-quantization data handling.
...
/// Struct CONFI_S4 for brain-quantization data handling.
...
/// Struct CONFI_S5 for brain-quantization data handling.
...
/// Struct CONFI_S6 for brain-quantization data handling.
...
/// Struct CONFI_S7 for brain-quantization data handling.
...
/// Struct CONFI_S8 for brain-quantization data handling.
...
/// Struct CONFI_S9 for brain-quantization data handling.
...
/// Struct CONFI_S10 for brain-quantization data handling.
...
/// Struct CONFI_S11 for brain-quantization data handling.
...
/// Struct CONFI_S12 for brain-quantization data handling.
...
/// Struct CONFI_S13 for brain-quantization data handling.
...
/// Struct CONFI_S14 for brain-quantization data handling.
...
/// Trait CONFI_T0 defining interface for brain-quantization.
pub trait CONFI_T0 {
...
/// Trait CONFI_T1 defining interface for brain-quantization.
pub trait CONFI_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait CONFI_T2 defining interface for brain-quantization.
pub trait CONFI_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait CONFI_T3 defining interface for brain-quantization.
pub trait CONFI_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait CONFI_T4 defining interface for brain-quantization.
pub trait CONFI_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait CONFI_T5 defining interface for brain-quantization.
pub trait CONFI_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
