...
/// Struct HELPE_S0 for brain-rnn data handling.
...
/// Struct HELPE_S1 for brain-rnn data handling.
...
/// Struct HELPE_S2 for brain-rnn data handling.
...
/// Struct HELPE_S3 for brain-rnn data handling.
...
/// Struct HELPE_S4 for brain-rnn data handling.
...
/// Struct HELPE_S5 for brain-rnn data handling.
...
/// Struct HELPE_S6 for brain-rnn data handling.
...
/// Struct HELPE_S7 for brain-rnn data handling.
...
/// Struct HELPE_S8 for brain-rnn data handling.
...
/// Struct HELPE_S9 for brain-rnn data handling.
...
/// Struct HELPE_S10 for brain-rnn data handling.
...
/// Struct HELPE_S11 for brain-rnn data handling.
...
/// Struct HELPE_S12 for brain-rnn data handling.
...
/// Struct HELPE_S13 for brain-rnn data handling.
...
/// Struct HELPE_S14 for brain-rnn data handling.
...
/// Trait HELPE_T0 defining interface for brain-rnn.
pub trait HELPE_T0 {
...
/// Trait HELPE_T1 defining interface for brain-rnn.
pub trait HELPE_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait HELPE_T2 defining interface for brain-rnn.
pub trait HELPE_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait HELPE_T3 defining interface for brain-rnn.
pub trait HELPE_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait HELPE_T4 defining interface for brain-rnn.
pub trait HELPE_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait HELPE_T5 defining interface for brain-rnn.
pub trait HELPE_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
