...
/// Struct PROCE_S1 for brain-rnn data handling.
...
/// Struct PROCE_S2 for brain-rnn data handling.
...
/// Struct PROCE_S3 for brain-rnn data handling.
...
/// Struct PROCE_S4 for brain-rnn data handling.
...
/// Struct PROCE_S5 for brain-rnn data handling.
...
/// Struct PROCE_S6 for brain-rnn data handling.
...
/// Struct PROCE_S7 for brain-rnn data handling.
...
/// Struct PROCE_S8 for brain-rnn data handling.
...
/// Struct PROCE_S9 for brain-rnn data handling.
...
/// Struct PROCE_S10 for brain-rnn data handling.
...
/// Struct PROCE_S11 for brain-rnn data handling.
...
/// Struct PROCE_S12 for brain-rnn data handling.
...
/// Struct PROCE_S13 for brain-rnn data handling.
...
/// Struct PROCE_S14 for brain-rnn data handling.
...
/// Trait PROCE_T0 defining interface for brain-rnn.
pub trait PROCE_T0 {
...
/// Trait PROCE_T1 defining interface for brain-rnn.
pub trait PROCE_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait PROCE_T2 defining interface for brain-rnn.
pub trait PROCE_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait PROCE_T3 defining interface for brain-rnn.
pub trait PROCE_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait PROCE_T4 defining interface for brain-rnn.
pub trait PROCE_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait PROCE_T5 defining interface for brain-rnn.
pub trait PROCE_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// comprehensive brain-rnn library. Each function is carefully optimized
