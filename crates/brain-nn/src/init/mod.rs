...
pub use kaiming::{kaiming_normal, kaiming_uniform, xavier_normal, xavier_uniform, InitConfig};
pub use schedule::{scaled_residual_init, zero_init_last_layer, InitPolicy};
pub use uniform::{normal_init, orthogonal_init, uniform_init, InitScheme};
