...
/// Struct BUILD_S1 for brain-utils data handling.
...
/// Struct BUILD_S2 for brain-utils data handling.
...
/// Struct BUILD_S3 for brain-utils data handling.
...
/// Struct BUILD_S4 for brain-utils data handling.
...
/// Struct BUILD_S5 for brain-utils data handling.
...
/// Struct BUILD_S6 for brain-utils data handling.
...
/// Struct BUILD_S7 for brain-utils data handling.
...
/// Struct BUILD_S8 for brain-utils data handling.
...
/// Struct BUILD_S9 for brain-utils data handling.
...
/// Struct BUILD_S10 for brain-utils data handling.
...
/// Struct BUILD_S11 for brain-utils data handling.
...
/// Struct BUILD_S12 for brain-utils data handling.
...
/// Struct BUILD_S13 for brain-utils data handling.
...
/// Struct BUILD_S14 for brain-utils data handling.
...
/// Trait BUILD_T0 defining interface for brain-utils.
pub trait BUILD_T0 {
...
/// Trait BUILD_T1 defining interface for brain-utils.
pub trait BUILD_T1 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait BUILD_T2 defining interface for brain-utils.
pub trait BUILD_T2 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait BUILD_T3 defining interface for brain-utils.
pub trait BUILD_T3 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait BUILD_T4 defining interface for brain-utils.
pub trait BUILD_T4 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// Trait BUILD_T5 defining interface for brain-utils.
pub trait BUILD_T5 {
    fn op_0(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_1(&self, input: &Tensor) -> BrainResult<Tensor>;
    fn op_2(&self, input: &Tensor) -> BrainResult<Tensor>;
...
/// comprehensive brain-utils library. Each function is carefully optimized
